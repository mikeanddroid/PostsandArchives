...
import com.mike.givemewingzz.postsandarchives.BuildConfig;
...
public class BaseClient {
    ...
    private static String initializeUserAgent() {
        return "PostsAndArchives/" + BuildConfig.VERSION_NAME + " (Build " + BuildConfig.VERSION_CODE + "; Android " + Build.VERSION.RELEASE + ')';
    }
